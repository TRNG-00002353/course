# Project 9: Non-Profit Organization Website (3-Member Version)
...
| About | Member C | Organization story, team, history |
...
- [ ] Nav links: About, Programs, Get Involved, Events, Contact
...
### Member C - Programs, Events & About
...
- [ ] Problem statement and solution approach for featured program
...
#### Feature 8: Events & Campaigns Page
...
#### Feature 9: About Page with Organization Story & Team
**Issue Title:** `feat: Create about page with history, mission, and team`

**User Story:**
> As a **visitor**, I want to **learn about the organization's history, mission, and leadership** so that **I can trust them with my donation**.
...
- [ ] Executive team and Board of Directors section
- [ ] Each profile: Photo, Name, Title, Brief bio
- [ ] Annual reports links
- [ ] Accreditations and ratings
- [ ] Partners and supporters logos
- [ ] Impact stories section with 2-3 beneficiary testimonials

**Technical Notes:**
- Timeline using list or custom CSS
- Cards for mission/vision/values and team profiles
...
8. `feat: Build events listing and campaign page`
9. `feat: Create about page with history, mission, and team`
